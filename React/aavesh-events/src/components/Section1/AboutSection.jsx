    ...
    <>
      <section className="home-about">
        <div className="habout-con">
          <div className="habout-content">
            ...
            <p className="habout-para">
              ...
              <br />
              <br />
              It is an avenue to be comforted from the routine life and to
              embrace the fun. Planned as a ‘for the students, of the students,
              by the students’ event, the festival is the most awaited event of
              the year.
            </p>
        ...
        <div className="habout-con-2">
          <div className="habout-imgs composition">
            <img className="composition__photo " src={about3} alt="" />
          </div>
          <div className="habout-content">
            ...
            <p className="habout-para-2">
              ...
              activities to young people and the wider community.<br/> 1. A quality
              inclusive working environment which is responsive to a member’s
              voice<br/> 2. Learning from the past mistakes and working together as a
              team for the betterment of the institution. <br/>3. Setting an ideal
              "benchmark” for the coming year students regarding managing vital
