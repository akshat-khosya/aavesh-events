			...
			<div className="home-conatiner">
				<div className="main-banner-content">
					...
					<p className="main-banner-p">
						Are you
						<span className="main-banner-p__span"> ready </span>
						to participate?
					</p>
					<h1 className="main-heading">
						<span className="main-heading-span">Aavesh</span>
						&nbsp;IIIT UNA&nbsp;
						<span className="main-heading-span">Presents</span>
						<br />
						TECHतत्त्व &nbsp;
						<b>2</b>
						<b>0</b>
					...
					<ul className="main-detail">
						...
						<li className="main-deatil__item">
							<i className="fas fa-calendar-alt"></i>29-31 Dec,
							2021
						</li>
					</ul>
